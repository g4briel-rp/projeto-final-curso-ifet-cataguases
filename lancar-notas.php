...
<script type="text/javascript" src="valida-notas.js"></script>
...
<center><h3>Selecione a turma:</h3></center>

<br><br><br><br>

<form method="post" action="lancar2.php" id="lancar" onsubmit="return validaForm();">
