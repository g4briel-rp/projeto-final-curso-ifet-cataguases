...
<center><h3>Alunos encontrados:</h3></center>

<br><br><br><br>

<table class="menu" bgcolor="lightblue" align="center">

<tr><td>Nome</td><td>Editar</td></tr>
...
<?php
	...
	if(!$con){
		...
		$aluno= $con->query("SELECT * FROM alunos WHERE nome = '$nome'");
		
		while($array = $aluno->fetch_array()){
			echo "<tr><td>$array[nome]</td><td align='center'><a href='alterar-n3.php'>X</a></td></tr>";
		}
	}
?>
