...
<script type="text/javascript" src="valida-altera-notas2.js"></script>
...
<center><h3>Selecione a disciplina:</h3></center>

<br><br><br><br>

<form method="post" action="alterar-n4.php" id="alterar-notas2" onsubmit="return validaForm();">
...
<?php	
	...
	if(!$con){
		...
		$disc= $con->query("SELECT * FROM alunos,curso_disc,disciplinas WHERE nome = '$_SESSION[nome]' AND alunos.IdCurso = curso_disc.IdCurso AND curso_disc.IdDisciplinas = disciplinas.IdDisciplinas");
